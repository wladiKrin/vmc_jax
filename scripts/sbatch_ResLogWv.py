...
srun python mainResWvLog.py --lattice 20 -g -1 --numSamples 40000 --exactRenorm False --numHidden 20 --filterSize 10 --tmax 2.0 --dt 1e-4 --integratorTol 1e-4 --invCutoff 1e-8
