...
numSamples = inp["simulation"]["num_samples"][i]
eps = inp["simulation"]["eps"][i]
...
param_name = "RBM_" + sampler_name + "Samp_L="+str(L) + "_J="+str(J)+"_numChannels="+str(numChannels)+"_numSamp="+str(numSamples)
