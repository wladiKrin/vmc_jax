...
param_name = "ResNet_HT_exact_Lx=%d_Ly=%d_h=%.3f_depth=%d_tol=%e_pinvTol=%e_numChannels=%d_filtersize=%d" % (Lx,Ly,theta_h,circuitDepth,tol,pinvTol,numChannels,filtersize)
