...
DEFAULT_DEPENDENCIES = ["setuptools", "wheel", "numpy>=2", "openfermion", "jax", "jaxlib", "flax>=0.7.0", "mpi4py", "h5py", "PyYAML", "matplotlib", "scipy"] # "scipy<1.13"] # Scipy version restricted, because jax is currently incompatible with new function namespace scipy.sparse.tril
